...
// header += '<li><a href="javascript:;" target="_self" class="user_anchor" title="로그인 페이지로 이동">로그인</a></li>';
...
// header += "<!-- 로그인 전 -->";
// header += '<div class="user_info">';
// header += '<p class="user_greet">김길동님 안녕하세요</p>';
// header += '<div class="mob_login_btn_wrap">';
// header += '<a class="white" href="javascript:;">회원가입</a>';
// header += '<a class="navy" href="javascript:;">로그인</a>';
// header += "</div>";
// header += "</div>";
// header += "<!-- 로그인 전 end -->";
// header += "</div>";
...
// header += '<li class="depth02_item"><a href="소개_이용절차.html" class="depth02_item_anchor" target="_self">연계 서비스 이용 절차</a></li>';
// header += '<li class="depth02_item"><a href="소개_이용신청.html" class="depth02_item_anchor" target="_self">연계 서비스 이용 신청</a></li>';
// header += "</ul>";
// header += "</div>";
// header += "</div>";
// header += "</li>";
...
// header += '<li class="depth02_item"><a href="사용자 지원_자료실.html" class="depth02_item_anchor" target="_self">자료실</a></li>';
...
// // header += '<button type="submit" class="search_submit" aria-label="홈페이지 내 검색" onclick="location.href=\'통합검색.html\'"></button>';
// header += '<button type="button" class="search_submit" aria-label="홈페이지 내 검색" onclick="location.href=\'통합검색.html\'"></button>';
// header += "</fieldset>";
// header += "</form>";
// header += "</div>";
// header += "<!-- 모바일 검색 영역 -->";
// header += '<div class="mob_wrap_search">';
// header += '<div class="search_top">';
// header += "<h1>민간 SaaS 연계공통기반 통합관리포털</h1>";
// header += '<button type="button">닫기</button>';
// header += "</div>";
// header += '<strong class="mob_wrap_srch_ttl">통합검색</strong>';
// header += "<fieldset>";
// header += '<label for="srchIn">검색어를 입력해 주세요.</label>';
// header += '<p class="mob_wrap_srch_input">';
// header += '<input id="srchIn" name="" type="text" />';
// header += '<button type="button"></button>';
// header += "</p>";
// header += "</fieldset>";
// header += "</div>";
// header += "<!-- 모바일 검색 영역 end -->";
// header += "</div>";
// header += "</div>";
// header += "</div>";
// header += "</div>";
