...
function renderProduct01() {
  const product01 = `
                      <li class="structured-item product_card product_01">
                        <div class="product_item_inner">
                          <div class="box_logo">
                            <img src="../img/saas_img/4_privateSaaS/logo_01.png" alt="공공용 계절근로자 관리 플랫폼 로고" class="viewer">
                          </div>
                          <div class="box_txt">
                            <div class="box_txt_inner">
                              <div class="card_top">
                                <span class="krds-badge bg-primary">문서관리</span>
                              </div>
                              <div class="card-body">
                                <div class="c-text">
                                  <div class="c-tit">
                                  ...
                                  <div class="tags">
                                    <span class="tag">전자서명</span>
                                    <span class="tag">근로자 관리</span>
                                  </div>
                                </div>
                              </div>
                              <p class="c_cnt">
...
//                 <div class="link_area">
//                   <span class="link_label">기관직접계약</span>
//                   <a href="javascript:;" target="_blank" class="krds-btn medium tertiary" title="새 창 열림- 디지털서비스 이용지원 홈페이지의 상세 페이지로 이동">이용지원시스템 이동<i class="svg-icon ico-go"></i></a>
//                 </div>
//               </div>
//             </div>
...
function renderProduct02() {
      ...
      <div class="product_item_inner">
        ...
        <div class="box_txt">
          <div class="box_txt_inner">
            ...
            <div class="wrap_detail_info">
              <ul class="detail_info_list">
                <li class="detail_info_list_item c-date">
                  <strong class="info_tit key">CSAP 인증</strong>
                  <span class="info_value value">간편</span>
                </li>
                <li class="detail_info_list_item c-date">
                  <strong class="info_tit key">인증 날짜</strong>
                  <span class="info_value value">2017.07.22 ~ 2026.07.21</span>
                </li>
                <li class="detail_info_list_item c-date">
                  <strong class="info_tit key">이용 인프라</strong>
                  <span class="info_value value">네이버 클라우드(공공)</span>
                </li>
                <li class="detail_info_list_item c-date">
                  <strong class="info_tit key">조달청 서비스몰</strong>
                  <span class="info_value value">계약 완료</span>
                </li>
              </ul>
            </div>
            <!-- 국가정보원 공시 영역 -->
            <div class="b_box">
              <p class="before_mark medal_icon">
                국가정보원 공시 국가공공기관 도입 가능 
  ...
  const target = document.querySelector('.product_card.product_02');
  if (target) {
    target.outerHTML = product02;
  }
}

function renderProduct03() {
  const product03 = `<li class="structured-item product_card product_03">
      <div class="product_item_inner">
        <div class="box_logo">
          ...
          <div class="box_txt_inner">
            ...
            <div class="card-btm">
              <div class="wrap_link_area">
                ...
                <div class="link_area">
                  <span class="link_label">기관직접계약</span>
                  <a href="javascript:;" target="_blank" class="krds-btn medium tertiary">이용지원시스템 이동<i class="svg-icon ico-go"></i></a>
                </div>
              </div>
            </div>
          </div>
  ...
  if (target) target.outerHTML = product03;
}
...
function renderProduct11() {
  const product11 = `
    <li class="structured-item product_card product_11">
      <div class="product_item_inner">
        <div class="box_logo">
          <img src="../img/saas_img/4_privateSaaS/logo_11.png" alt="두레이 로고" class="viewer">
        </div>
        <div class="box_txt">
          <div class="box_txt_inner">
            <div class="card_top">
            ...
            <div class="card-body">
              <div class="c-text">
                ...
                <p class="company_name">두레이</p>
                <div class="tags">
                  <span class="tag">협업</span>
                  <span class="tag">드라이브</span>
                  <span class="tag">메일</span>
                  <span class="tag">메신저</span>
                  <span class="tag">업무관리</span>
                  <span class="tag">전자결재</span>
            ...
            <div class="wrap_detail_info">
              <ul class="detail_info_list">
                <li class="detail_info_list_item c-date"><strong class="info_tit key">CSAP 인증</strong><span class="info_value value">표준</span></li>
                <li class="detail_info_list_item c-date"><strong class="info_tit key">인증 날짜</strong><span class="info_value value">2025.12.11~2029.12.17</span></li>
                <li class="detail_info_list_item c-date"><strong class="info_tit key">이용 인프라</strong><span class="info_value value">네이버 클라우드(공공)</span></li>
                <li class="detail_info_list_item c-date"><strong class="info_tit key">중앙조달계약</strong><span class="info_value value">계약 완료</span></li>
              </ul>
            </div>
  ...
  const target = document.querySelector('.product_card.product_11');
  if (target) target.innerHTML = product11;
}

function renderProduct12() {
  const product12 = `
    <li class="structured-item product_card product_12">
      <div class="product_item_inner">
        <div class="box_logo">
          <img src="../img/saas_img/4_privateSaaS/logo_12.png" alt="공공기관용 ERP서비스(well-formed 공공Erp시스템)
 로고" class="viewer">
        </div>
        <div class="box_txt">
          <div class="box_txt_inner">
            ...
            <div class="card-body">
              <div class="c-text">
                ...
                <p class="company_name">하이퍼테크</p>
                <div class="tags">
                  <span class="tag">경영관리</span>
                  <span class="tag">급여관리</span>
                  <span class="tag">복무관리</span>
                  <span class="tag">인사관리</span>
                  <span class="tag">시스템관리</span>
                  <span class="tag">협업</span>
                </div>
                <div class="b_box">
                  <p>정부 공통시스템 연계</p>
            ...
            <div class="wrap_detail_info">
              <ul class="detail_info_list">
                <li class="detail_info_list_item c-date"><strong class="info_tit key">CSAP 인증</strong><span class="info_value value">표준</span></li>
                <li class="detail_info_list_item c-date"><strong class="info_tit key">인증 날짜</strong><span class="info_value value">2025.10.24~2029.10.23</span></li>
                <li class="detail_info_list_item c-date"><strong class="info_tit key">이용 인프라</strong><span class="info_value value">KT G-Cloud</span></li>
                <li class="detail_info_list_item c-date"><strong class="info_tit key">중앙조달계약</strong><span class="info_value value">해당 없음</span></li>
              </ul>
            </div>
  ...
  const target = document.querySelector('.product_card.product_12');
  if (target) target.innerHTML = product12;
}
