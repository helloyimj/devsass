...
header +=                       '<div class="logo"><a class="logo_anchor" aria-label="메인페이지 이동" href=""></a></div>';
header +=                   '</div>';
...
header +=                                       '<div class="depth01_item"><a class="depth01_item_anchor" target="_self" tabindex="0">센터 소개</a></div>';
header +=                                       '<div class="depth02_content">';
header +=                                           '<ul class="depth02">';
header +=                                               '<li class="depth02_item"><a class="depth02_item_anchor" target="_self" tabindex="0">1</a></li>';
header +=                                               '<li class="depth02_item"><a class="depth02_item_anchor" target="_self" tabindex="0">2</a></li>';
header +=                                               '<li class="depth02_item"><a class="depth02_item_anchor" target="_self" tabindex="0">3</a></li>';
header +=                                           '</ul>';
header +=                                       '</div>';
header +=                                   '</li>';
header +=                                   '<li class="depth01">';
header +=                                       '<div class="depth01_item"><a class="depth01_item_anchor" target="_self" tabindex="0">전환사업 소개</a></div>';
header +=                                       '<div class="depth02_content">';
header +=                                           '<ul class="depth02">';
header +=                                               '<li class="depth02_item"><a class="depth02_item_anchor" target="_self" tabindex="0">1</a></li>';
header +=                                               '<li class="depth02_item"><a class="depth02_item_anchor" target="_self" tabindex="0">2</a></li>';
...
header +=                                   '</li>';
header +=                                   '<li class="depth01">';
header +=                                       '<div class="depth01_item"><a class="depth01_item_anchor" target="_self" tabindex="0">커뮤니티</a></div>';
header +=                                       '<div class="depth02_content">';
header +=                                           '<ul class="depth02">';
header +=                                               '<li class="depth02_item"><a class="depth02_item_anchor" target="_self" tabindex="0">4</a></li>';
header +=                                               '<li class="depth02_item"><a class="depth02_item_anchor" target="_self" tabindex="0">1</a></li>';
header +=                                               '<li class="depth02_item"><a class="depth02_item_anchor" target="_self" tabindex="0">2</a></li>';
header +=                                           '</ul>';
header +=                                       '</div>';
...
footer +=  		                '<img src="../img/logo/logo_cpcp.png" alt="행정·공공기관 클라우드 전환센터">';
footer +=  		            '</div>';
footer +=  		            '<div class="wrap_address">';
footer +=  		                '<ul class="list_address">';
footer +=  		                    '<li class="list_address_item">(41068) 대구광역시 동구 첨단로 53</li>';
footer +=  		                '</ul>';
footer +=  		                '<a href="javascript:;" class="link_map" target="_blank" title="새 창 열림-찾아오시는 길">찾아오시는 길</a>';
footer +=  		            '</div>';
footer +=  		            '<div class="wrap_address wrap_address02">';
footer +=  		                '<ul class="list_address">';
footer +=  		                    '<li class="list_address_item">대표전화 : 1522-0089</li>';
footer +=  		                    '<li class="list_address_item">이메일 : cpcp@nia.or.kr</li>';
footer +=  		                '</ul>';
footer +=  		            '</div>';
footer +=  		        '</div>';
footer +=  		    '</div>';
...
footer +=  		                '<p>Copyright@ 한국지능정보사회진흥원 All Rtights Reserved.</p>';
footer +=  		            '</div>';
footer +=  		        '</div>';
footer +=  		    '</div>';
// footer +=  		    '</footer>';
