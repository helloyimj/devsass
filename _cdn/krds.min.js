let windowSize = {
  ...
  scrollManager = {
    ...
    handleScrollDirection () {
      ...
      i &&
        ...
        (a = (t = window.scrollY) > this._lastScrollY),
        (s = t < this._lastScrollY),
        e + 50 < t && a
  ...
  krds_mainMenuPC = {
    ...
    setupMainTrigger (e) {
      ...
      a &&
        ...
        a.setAttribute('id', t),
        'true' ===
          (e = a.querySelector('.gnb-main-list'))?.getAttribute(
            'data-has-submenu'
          )) &&
        ((t = e.querySelectorAll('.gnb-sub-trigger')).forEach(e =>
          this.setupSubTrigger(e)
        ),
        0 < t.length) &&
    ...
    toggleMainMenu (e) {
      var t = e.classList.contains('active'),
        a = e.classList.contains('is-dropdown')
        ...
        ? (this.resetMainMenu(),
          ...
          a ||
            ...
            this.adjustSubMenuHeight(
              e.nextElementSibling.querySelector('.gnb-main-list')
            )))
        : this.closeMainMenu()
    },
    toggleSubMenu (e) {
    ...
    attachEvents (e, t) {
      document.addEventListener('click', ({ target: e }) => {
        ...
        document.addEventListener('keyup', e => {
          ;('Escape' !== e.code && e.target.closest('.krds-main-menu')) ||
            this.closeMainMenu()
        }),
        e.forEach(e => {
    ...
    setupKeyboardNavigation (s) {
      ...
      document.addEventListener('keydown', e => {
        ...
        if (t.getAttribute('data-trigger'))
          switch (e.key) {
            case 'Home':
              e.preventDefault(), i(s[0])
              break
            case 'End':
              e.preventDefault(), i(s[s.length - 1])
              break
            case 'ArrowRight':
            case 'ArrowDown':
              e.preventDefault()
  ...
  krds_mainMenuMobile = {
    ...
    setupAriaAttributes (e) {
      ...
      e &&
        ...
        e
          ...
          .forEach(e => e.setAttribute('role', 'none')),
        document
          ...
          .forEach((t, e) => {
            t.setAttribute('role', 'tab'),
              ...
              t.setAttribute(
                'aria-controls',
                t.getAttribute('href').substring(1)
              ),
              ...
              t.addEventListener('click', e => {
                ...
                document
                  .querySelector('.gnb-body')
                  .scrollTo({ left: 0, top: e, behavior: 'smooth' })
              })
          }),
        document
          .querySelectorAll('.submenu-wrap .gnb-sub-list')
          .forEach((e, t) => {
    ...
    attachEvents (e) {
      var t = e.getAttribute('id'),
        ...
        a = e.querySelector('#close-nav')
      t.addEventListener('click', () => this.openMainMenu(e)),
        a.addEventListener('click', () => this.closeMainMenu(e)),
    ...
    openMainMenu (t) {
      let a = t.querySelector('.gnb-wrap')
      ;(t.style.display = 'block'), a.setAttribute('tabindex', 0)
      var e,
        s = document.querySelector('.gnb-main-trigger.active')
      s &&
        ((s = s.getAttribute('aria-controls')),
        (s = document.getElementById(s).offsetTop),
        ((e = document.querySelector('.gnb-body')).style.scrollBehavior =
          'auto'),
        (e.scrollTop = s)),
        setTimeout(() => {
    ...
    closeMainMenu (t) {
      ...
      let a = document.querySelector(`[aria-controls=${e}]`)
      t.classList.remove('is-backdrop'),
        ...
        t.addEventListener('transitionend', function e () {
          a.focus(), t.removeEventListener('transitionend', e)
        }),
        setTimeout(() => {
          ;(t.style.display = 'none'),
            ...
            e.forEach(t => {
              t.classList.contains('active')
                ? (t.classList.add('active'),
                  ...
                  t.nextElementSibling.classList.add('is-open'))
    ...
    handleDepth4Click (e) {
      ...
      var a = t.querySelector('.trigger-prev'),
        s = t.querySelector('.trigger-close'),
        i =
  ...
  krds_sideNavigation = {
    ...
    setupSideNavLists () {
      document
        .querySelectorAll('.krds-side-navigation .lnb-list')
        .forEach(e => {
    ...
    setupNavItem (e) {
      ...
      e &&
        ...
        e.classList.contains('lnb-toggle-popup') &&
          e.setAttribute('aria-haspopup', 'true'),
        a) &&
        a.className.includes('lnb-submenu') &&
        (a.classList.contains('lnb-submenu-lv2')
          ? a
          : a.querySelector(':scope > ul')
        )?.setAttribute('id', t)
    },
    setupToggleEvents () {
      document
    ...
    setupPopupEvents () {
      ...
      e.forEach(t => {
        t.addEventListener('click', () => {
          ...
          e &&
            e.classList.contains('lnb-submenu-lv2') &&
            (e.classList.add('active'),
            t.setAttribute('aria-expanded', 'true'),
            e.addEventListener(
              'transitionend',
    ...
    setActiveCurrentPage () {
      let t = window.location.pathname
        ...
        .replace('.html', '')
      document
        .querySelectorAll('.krds-side-navigation .lnb-link')
        .forEach(e => {
          e.getAttribute('href').split('/').pop().replace('.html', '') === t &&
            (e.closest('.lnb-item').classList.add('active'),
            e
              .closest('.lnb-item')
  ...
  krds_tab = {
    ...
    setupTabs () {
      this.layerTabArea.forEach(e => {
        e.querySelectorAll('.tab > ul > li').forEach(s => {
          if (!s.dataset.listenerAttached) {
            ...
            s.setAttribute('aria-selected', 'false'),
              ...
              !s.classList.contains('active') ||
                s.querySelector('button .sr-only') ||
                (s.setAttribute('aria-selected', 'true'),
                s.querySelector('button').append(this.createAccText())),
              ...
              this.setupKeyboardNavigation(s),
    ...
    setupKeyboardNavigation (a) {
      a.addEventListener('keydown', function (e) {
        ...
        'ArrowRight' === e.key
          ? (e.preventDefault(),
            (t = a.nextElementSibling?.querySelector('button')))
          : 'ArrowLeft' === e.key &&
            (t = a.previousElementSibling?.querySelector('button')),
          t?.focus()
      })
    }
  },
  krds_accordion = {
    ...
    accordionToggle (e, t, a, s) {
      ...
      'multiOpen' === a ||
        ...
        s.classList.toggle('active', !i)
    },
    setupAccordions () {
      this.accordionButtons.forEach((e, t) => {
        var a = e.closest('.krds-accordion'),
          s = a.querySelectorAll('.accordion-item'),
          i = e.closest('.accordion-item'),
          r = i.querySelector('.accordion-collapse'),
          l = a.dataset.type || 'singleOpen',
          a = a.classList.contains('is-open')
        ...
        n ||
          ((n = this.accordionToggle.bind(this, e, s, l, i)),
          this.accordionHandlers.set(e, n)),
          e.removeEventListener('click', n),
          e.addEventListener('click', n)
      })
    },
    setupAriaAttributes (e, t, a) {
      a = '' + a + Math.random().toString(36).substring(2, 9)
      e.setAttribute('aria-expanded', 'false'),
        e.setAttribute('id', 'accordionHeader-id-' + a),
        e.setAttribute('aria-controls', 'accordionCollapse-id-' + a),
        t.setAttribute('role', 'region'),
        t.setAttribute('id', 'accordionCollapse-id-' + a),
        t.setAttribute('aria-labelledby', 'accordionHeader-id-' + a)
    }
  },
  krds_modal = {
    ...
    init () {
      ;(this.modalOpenTriggers = document.querySelectorAll('.open-modal')),
        ...
        this.modalOpenTriggers.length &&
          this.modalCloseTriggers.length &&
          this.setupTriggers()
    },
    setupTriggers () {
      this.modalOpenTriggers.forEach(t => {
        t.addEventListener('click', e => {
          ...
          e &&
            (t.setAttribute('data-modal-id', e),
    ...
    openModal (e) {
      let t = document.getElementById(e),
        a = t.querySelector('.modal-content')
      var s = t.querySelector('.modal-back'),
        ...
        a.addEventListener(
          ...
          e => {
            ;('Escape' !== e.key && 'Esc' !== e.key) ||
              this.closeModal(a.closest('.krds-modal').id)
          },
          { once: !0 }
        ),
    ...
    closeModal (e) {
      let t = document.getElementById(e)
      var a = document.querySelectorAll('.modal.in:not(.sample)'),
        s = t.querySelector('.modal-back')
  ...
  krds_contextualHelp = {
    ...
    init () {
      ;(this.tooltipButtons = document.querySelectorAll(
        ...
        this.tooltipButtons.length &&
          (this.setupTooltips(), this.setupFocusOutEvent())
    },
    setupTooltips () {
      this.tooltipButtons.forEach(e => {
        let t = e.closest('.krds-contextual-help'),
          a = t.querySelector('.tooltip-popover')
        var s = a.querySelector('.tooltip-close')
        e.setAttribute('aria-expanded', 'false'),
          a.setAttribute('role', 'tooltip'),
          t && 1 === t.classList.length && t.classList.add('top', 'left'),
          e.addEventListener('click', () => {
            this.toggleTooltip(e, a, t)
          }),
          s.addEventListener('click', () => {
            this.closeAllTooltips()
          }),
          window.addEventListener('resize', () => {
            this.adjustTooltipPosition(t, a)
          }),
          document.addEventListener('keydown', e => {
      ...
      this.closeAllTooltips(),
        s ||
          ...
          t
            ...
            ?.focus(),
          e.setAttribute('aria-expanded', 'true'),
          this.adjustTooltipPosition(a, t))
    },
    closeAllTooltips () {
      document
    ...
    adjustTooltipPosition (e, t) {
      ...
      a
        ? ((a = getComputedStyle(document.querySelector(':root'))
            .getPropertyValue('--krds-contents-padding-x')
            .trim()
            .split('px')[0]),
          (e = e.getBoundingClientRect().left - a),
          (a = document.body.clientWidth - 2 * a),
          (t.style.left = `-${e}px`),
          (t.style.width = a + 'px'))
        ...
        t
          ? t
              ...
              .addEventListener('focusout', () => {
                this.closeAllTooltips(),
                  t.querySelector('.tooltip-btn')?.focus()
              })
          : this.closeAllTooltips()
      })
    }
  ...
  krds_tooltip = {
      ...
      this.tooltip.forEach((t, a) => {
        ...
        if (s && !i) {
          ;(i =
            ...
            (a = (t.setAttribute('aria-labelledby', i), t.innerText))
          let e = this.createTooltipPopover(i, a, s)
    ...
    createTooltipPopover (e, t, a) {
      var s = document.createElement('div')
      return (
        s.classList.add('krds-tooltip-popover'),
        s.setAttribute('id', e),
    ...
    showTooltip (e, t) {
      e.classList.contains('tooltip-box') && t.classList.add('tooltip-box'),
        e.classList.contains('tooltip-vertical') &&
          t.classList.add('tooltip-vertical'),
        t.classList.add('active')
      var { top: e, left: a } = this.calculateTooltipPosition(e, t),
        s = window.innerWidth <= 420
      ;(t.style.top = e + 'px'), (t.style.left = s ? '50%' : a + 'px')
    },
    closeAllTooltips () {
      document.querySelectorAll('.krds-tooltip-popover').forEach(e => {
        e.classList.contains('active') &&
          ((e.style = ''), (e.className = 'krds-tooltip-popover'))
      })
    },
    calculateTooltipPosition (e, t) {
      var { clientHeight: a, clientWidth: s } = t,
        {
          top: i,
          left: r,
          right: l,
      ...
      return (
        this.isMobile ||
        e.classList.contains('tooltip-box') ||
        e.classList.contains('tooltip-vertical')
          ? (c < i + n
              ? ((p = i - a - 12), t.classList.add('top'))
              : ((p = i + n + 12), t.classList.add('bottom')),
            d < r + o
              ? ((u = l - s),
                t.classList.add('right'),
                window.innerWidth - (r + o) > s / 2 &&
                  ((u = r + (o - s) / 2), t.classList.remove('right')))
              : (u = r + (o - s) / 2) < 0
              ? ((u = r), t.classList.add('left'))
              : t.classList.remove('left'))
          : ((p = i + (n - a) / 2),
            d < r + o
              ? ((u = r - s - 12), t.classList.add('right'))
  ...
  krds_calendar = {
    ...
    setupDateComboBox (e, t) {
      var a = document.querySelectorAll('.calendar-drop-down > button')
      'init' === e &&
        a.forEach((t, e) => {
          var a = t.nextElementSibling.querySelector('.sel'),
            s = a.querySelectorAll('button'),
          ...
          t.setAttribute('role', 'combobox'),
            ...
            a.setAttribute('id', 'combo-list-' + e),
            a
              .querySelectorAll('li')
              .forEach(e => e.setAttribute('role', 'none')),
            s.forEach(e => {
        ...
        'change' === e &&
          ...
          t &&
            ...
            (t
              ...
              .querySelector('button').innerHTML = t.innerHTML)),
          this.example())
    },
    toggleDateSelector () {
      this.datePickerArea.forEach(e => {
        var t = e.querySelectorAll('.calendar-drop-down .btn-cal-switch'),
          a = e.querySelectorAll('.calendar-select .sel button')
        let s = (e, t) => {
    ...
    actionDatePicker () {
      this.datePickerArea.forEach(e => {
        e.querySelectorAll('.calendar-btn-wrap button:not(#get-today)').forEach(
          e => {
            e.addEventListener('click', () => {
              this.closeAllDatePickers()
            })
    ...
    example () {
      this.datePickerArea.forEach(e => {
        ...
        var t = e.querySelector('.calendar-tbl caption'),
          a = e.querySelectorAll('.calendar-tbl td')
        let l = e.querySelectorAll('.calendar-tbl td .btn-set-date'),
          s = e.querySelectorAll('.calendar-btn-wrap button'),
          n = 0,
          o = null,
          d =
            ((t.innerHTML = `${i}년 ${r}월`),
            a.forEach(e => {
              ...
              let [a, s] = [parseFloat(i), parseFloat(r)]
        ...
        l.forEach(t => {
          t.closest('td.new, td.old') && t.setAttribute('disabled', 'true'),
            t.closest('.calendar-wrap').classList.contains('single')
              ? (t.addEventListener('click', () => {
                  l.forEach(e => {
              ...
              : (t.addEventListener('click', () => {
                  let s = t.closest('td')
                  var e = new Date(s.getAttribute('data-date'))
                  if (
                    (o &&
                      e < new Date(o.getAttribute('data-date')) &&
  ...
  krds_inPageNavigation = {
    ...
    applyScroll (e, t) {
      t.preventDefault()
      var a = this.calculateHeaderHeight()
      window.scrollTo({
        left: 0,
        top: e.getBoundingClientRect().top + window.scrollY - a,
        behavior: 'smooth'
      }),
        'keydown' === t.type &&
          (a = e.querySelector('.sec-tit')) &&
          (a.setAttribute('tabindex', '-1'), a.focus({ preventScroll: !0 }))
    },
    ...
    updateActiveSection () {
      if (this.quickIndicators) {
        ...
        let e = []
        var a,
          s = document.querySelector('.tab-conts:not(.sample).active')
        if (
          (s
            ? ((a = s.getAttribute('id')),
              'true' === s.getAttribute('data-quick-nav') &&
                (e = document.querySelectorAll(`#${a} .section-link`)))
            : (e = document.querySelectorAll('.scroll-check .section-link')),
          0 < e.length)
        ) {
          let r = Math.ceil(t / 5),
            l = e[0].offsetTop,
          ...
          e.forEach(e => {
            var t = e.offsetHeight,
              ...
              e = document.querySelector(
                `.krds-in-page-navigation-area a[href*=${e}]`
              ),
            ...
            n >= o
              ...
              : window.scrollY <= l
              ? this.setActiveIndicator(s)
              : a < window.scrollY &&
                window.scrollY <= a + t &&
                this.setActiveIndicator(e)
          })
        }
      }
    },
  ...
  krds_helpPanel = {
    ...
    init () {
      ;(this.helpPanel = document.querySelector('.krds-help-panel')),
        this.helpPanel &&
          ...
          (this.collapseButton = this.helpPanel.querySelector(
            '.btn-help-panel.fold'
          )),
          this.setupPadding(),
    ...
    setupPadding () {
      var e = document.querySelector('#krds-masthead')?.offsetHeight,
        ...
        e = e + t
      let a = document.querySelector('.help-panel-wrap'),
        s = document.querySelector('.btn-help-panel.expand')
      var i = e => {
        ;(s.style.marginTop = e),
          'pc' === windowSize.getWinSize()
            ? ((a.style.paddingTop = e),
              (this.collapseButton.style.marginTop = e))
    ...
    toggleHelpPanel (e, t) {
      let a = document.querySelector('.help-panel-wrap')
      var s = document.querySelector('#container > .inner')
      a &&
        s &&
        this.helpPanel &&
        ('open' === e
          ? ('mob' === windowSize.getWinSize() &&
            ...
            s.classList.contains('help-panel-flexible') &&
              s.classList.add('help-panel-expanded'))
          : 'close' === e &&
            ('mob' === windowSize.getWinSize() &&
            ...
            a.removeAttribute('tabindex'),
            (
              this.lastFocusedButton ||
              document.querySelector('.btn-help-panel.expand')
            ).focus(),
            this.executeButton.forEach(e => {
              e.setAttribute('aria-expanded', 'false')
            }),
            s.classList.contains('help-panel-flexible')) &&
            s.classList.remove('help-panel-expanded'))
    },
    toggleScrollLock () {
      setTimeout(() => {
        'mob' === windowSize.getWinSize() &&
    ...
    setupDisclosure () {
      this.disclosures.forEach(e => {
        let t = e.querySelector('.btn-conts-expand'),
          a = e.querySelector('.expand-wrap')
        var s = 'disclosure-' + Math.random().toString(36).substring(2, 9)
        t &&
          (t.setAttribute('aria-expanded', 'false'),
          ...
          t.addEventListener('click', () => {
            this.toggleDisclosure(e, t, a)
          }))
      })
    },
    toggleDisclosure (e, t, a) {
      var s = 'true' === t.getAttribute('aria-expanded')
      e.classList.toggle('active', !s),
        t.setAttribute('aria-expanded', !s),
        s ? a.setAttribute('inert', '') : a.removeAttribute('inert')
    }
  },
  krds_adjustContentScale = {
    ...
    init () {
      ...
      if (e.length) {
        ...
        e.forEach(a => {
          a.addEventListener('click', () => {
            switch (a.getAttribute('data-adjust-scale')) {
              case 'sm':
                this.scaleValue(s)
                break
              case 'md':
                var e = a.closest('.drop-menu').querySelectorAll('.item-link'),
                  t = a.closest('.drop-menu').querySelector('.item-link.md')
                e.forEach(e => {
                  e.classList.remove('active'),
                    e.setAttribute('aria-selected', 'false'),
  ...
  krds_dropEvent = {
    ...
    init () {
      ;(this.dropButtons = document.querySelectorAll(
        ...
        this.dropButtons.length &&
          (this.setupEventListeners(), this.setupFocusOutEvent())
    },
    setupEventListeners () {
      this.dropButtons.forEach(t => {
        ...
        t.setAttribute('aria-expanded', 'false'),
          t.addEventListener('click', () => {
            var e = 'block' === a.style.display
            this.closeAllDropdowns(), e || this.openDropdown(t, a)
          }),
          this.setupMenuItems(a)
      })
    },
    setupMenuItems (e) {
      e.querySelectorAll('.item-link').forEach(e => {
        ;(e.innerHTML += '<span class="sr-only"></span>'),
          e.classList.contains('active') &&
            (e.querySelector('.sr-only').innerHTML = '선택됨'),
          e.addEventListener('click', () => {
    ...
    openDropdown (e, t) {
      ...
      e.left < 0
        ...
        : a < e.left + e.width &&
          t.closest('.krds-drop-wrap').classList.add('drop-right')
    },
    closeAllDropdowns () {
        ...
        e.querySelectorAll('li').forEach(e => {
          ...
          if (null != t) {
            ...
            1 == a
              ...
              : 1 == e && s.classList.add('checked'),
              t.addEventListener('click', () => {
                e =
                  1 == e
                    ? (s.classList.remove('checked'), !1)
                    : (s.classList.add('checked'), !0)
              })
          }
      ...
      document.querySelectorAll('.file-upload').forEach(t => {
        ...
        t.querySelector('button').addEventListener('click', () => {
          ...
          t.addEventListener('dragleave', e => {
            t.classList.remove('active'), e.preventDefault()
          }),
    ...
    init () {
      document.querySelectorAll('#krds-masthead .toggle-btn').forEach(e => {
        e.addEventListener('click', e => {
          ...
          let a = t.nextElementSibling
          var s = a.querySelector('.inner').scrollHeight,
            ...
            : ((e.innerText = '닫힘'),
              ...
              window.addEventListener('resize', () => {
                ...
                a.classList.contains('active') &&
                  ((e = a.querySelector('.inner').scrollHeight),
                  (a.style.height = e + 'px'))
              }))
        })
      })
...
var Swiper = (function () {
    ...
    X = {
      ...
      updateSlides: function () {
        ...
        if (void 0 !== l) {
          'string' == typeof w && 0 <= w.indexOf('%')
            ...
            r.centeredSlides &&
              r.cssMode &&
              (A(e, '--swiper-centered-offset-before', ''),
          ...
          for (let s = 0; s < u; s += 1) {
            ...
            if (
              ((o = 0),
              p[s] && (n = p[s]),
              T && i.grid.updateSlide(s, n, p),
              !p[s] || 'none' !== M(n, 'display'))
            ) {
              if ('auto' === r.slidesPerView) {
                L && (p[s].style[i.getDirectionLabel('width')] = '')
                ...
                (o = (l - (r.slidesPerView - 1) * w) / r.slidesPerView),
                  r.roundLengths && (o = Math.floor(o)),
                  p[s] && (p[s].style[i.getDirectionLabel('width')] = o + 'px')
          ...
          if (
            ...
            a &&
              ...
              (e.style.width = i.virtualSize + w + 'px'),
            r.setWrapperSize &&
      ...
      updateSlidesClasses: function () {
        let t = this,
          ...
          n = e => q(s, `.${a.slideClass}${e}, swiper-slide` + e)[0],
          o,
          d,
          c
        if (
        ...
        o &&
          ...
          l
            ? c && c.classList.add(a.slideNextClass)
            : ((c = (function (e, t) {
      ...
      updateActiveIndex: function (e) {
        ...
        if ((o >= a.length && (o = a.length - 1), d !== r || s.params.loop))
          if (d === r && s.params.loop && s.virtual && s.params.virtual.enabled)
            ...
            var c = s.grid && i.grid && 1 < i.grid.rows
            let a
      ...
      transition: {
        ...
        transitionStart: function (e, t) {
          ...
          a.cssMode ||
            ...
            V({ swiper: this, runCallbacks: e, direction: t, step: 'Start' }))
        },
        transitionEnd: function (e, t) {
          ...
          ;(this.animating = !1),
            a.cssMode ||
              ...
              V({ swiper: this, runCallbacks: e, direction: t, step: 'End' }))
        }
      },
      slide: {
        slideTo: function (e, s, t, a, i) {
          ...
          if (
            ...
            return (
              ...
              'reset' != f && (r.transitionStart(t, f), r.transitionEnd(t, f)),
              !1
            )
          if (n.cssMode) {
            ...
            if (0 === s) {
              ...
              e &&
                ...
                e && !r._cssModeVirtualInitialSet && 0 < r.params.initialSlide
                  ? ((r._cssModeVirtualInitialSet = !0),
                    requestAnimationFrame(() => {
                      m[t ? 'scrollLeft' : 'scrollTop'] = a
                    }))
                  : (m[t ? 'scrollLeft' : 'scrollTop'] = a),
                e &&
                  requestAnimationFrame(() => {
              ...
              if (!r.support.smoothScroll)
                return (
                  b({ swiper: r, targetPosition: a, side: t ? 'left' : 'top' }),
                  !0
                )
              m.scrollTo({ [t ? 'left' : 'top']: a, behavior: 'smooth' })
            }
          } else
            r.setTransition(s),
              r.setTranslate(g),
              r.updateActiveIndex(l),
              r.updateSlidesClasses(),
              r.emit('beforeTransitionStart', s, a),
          ...
          if (!l.destroyed) {
            ...
            if (l.params.loop)
              if (l.virtual && l.params.virtual.enabled)
                ...
                } else a = l.getSlideIndexByData(r)
                let t = n
                    ? Math.ceil(l.slides.length / l.params.grid.rows)
                    : l.slides.length,
                  s = l.params.centeredSlides,
                  e = l.params.slidesPerView,
                  i =
                    ('auto' === e
                      ? (e = l.slidesPerViewDynamic())
                      : ((e = Math.ceil(
                          parseFloat(l.params.slidesPerView, 10)
                        )),
                        s && e % 2 == 0 && (e += 1)),
                    t - a < e)
                if ((i = s ? i || a < Math.ceil(e / 2) : i)) {
                  let e = s
                    ? a < l.activeIndex
                      ? 'prev'
                      : 'next'
                ...
                } else r = l.getSlideIndexByData(r)
              }
            return (
              requestAnimationFrame(() => {
                l.slideTo(r, t, a, s)
        ...
        slidePrev: function (t, a, s) {
          ...
          if (
            (void 0 !== h &&
              ((v = l.indexOf(h)) < 0 && (v = i.activeIndex - 1),
              ...
              ? a.animating ||
                ...
                s.centeredSlides
                  ? t < a.loopedSlides - r / 2 ||
                    ...
                    ? (a.loopFix(),
                      (t = a.getSlideIndex(
                        q(i, l + `[data-swiper-slide-index="${e}"]`)[0]
                      )),
                      L(() => {
                        a.slideTo(t)
                      }))
      ...
      loop: {
        loopCreate: function (e) {
          ...
          !s.loop ||
            (a.virtual && a.params.virtual.enabled) ||
            ((i = () => {
              q(t, `.${s.slideClass}, swiper-slide`).forEach((e, t) => {
            ...
            (o = t => {
              for (let e = 0; e < t; e += 1) {
                let e = a.isElement
                  ? I('swiper-slide', [s.slideBlankClass])
                  : I('div', [s.slideClass, s.slideBlankClass])
                a.slidesEl.append(e)
              }
            }),
            l
        ...
        loopFix: function (m) {
          ...
          if (S.params.loop) {
            ...
            if (
              ...
              void 0 === b
                ? (b = S.getSlideIndex(
                    o.filter(e => e.classList.contains(p.slideActiveClass))[0]
                  ))
                : (r = b)
              var x = 'next' === g || !g,
                T = 'prev' === g || !g
              ...
              var L = E ? Math.ceil(o.length / p.grid.rows) : o.length,
                M =
                  (E ? o[b].column : b) + (u && void 0 === f ? -e / 2 + 0.5 : 0)
              if (M < a) {
                l = Math.max(a - M, m)
                for (let t = 0; t < a - M; t += 1) {
                ...
                n = Math.max(M - (L - 2 * a), m)
                for (let e = 0; e < n; e += 1) {
                  let a = e - Math.floor(e / L) * L
                  E
                    ? o.forEach((e, t) => {
                        e.column === a && i.push(t)
                      })
              ...
              if (
                ...
                if (0 < s.length && T) {
                  if (void 0 === h) {
                    ...
                    let e = E ? s.length / p.grid.rows : s.length
                  ...
                  ? S.controller.control.forEach(e => {
                      !e.destroyed &&
                        ...
                        e.loopFix({
                          ...t,
                          slideTo:
                            e.params.slidesPerView === p.slidesPerView && v
                        })
                    })
      ...
      events: {
        attachEvents: function () {
          ...
          ;(e.onTouchStart = function (a) {
            ...
            if ('touchstart' === r.type) F(s, r, r.targetTouches[0].pageX)
            else {
            ...
            (e.onTouchMove = function (t) {
              ...
              if (e && (l.simulateTouch || 'mouse' !== t.pointerType)) {
                ...
                if (r.isTouched) {
                  var t = e.pageX,
                    d = e.pageY
                  if (s.preventedByNestedSwiper) (n.startX = t), (n.startY = d)
                    ...
                    if (
                      ...
                      if (
                        !(
                          i.params.threshold &&
                          Math.sqrt(c ** 2 + p ** 2) < i.params.threshold
                        )
                      )
                        if (
        ...
        setBreakpoint: function () {
          ...
          if (d && 0 !== Object.keys(d).length) {
            ...
            if (c && i.currentBreakpoint !== c) {
              let s = (c in d ? d[c] : void 0) || i.originalParams,
                e = U(i, n),
                t = U(i, s),
                a = n.enabled
              e && !t
                ...
                : !e &&
                  ...
                  ((s.grid.fill && 'column' === s.grid.fill) ||
                    (!s.grid.fill && 'column' === n.grid.fill)) &&
              ...
              var p = s.direction && s.direction !== n.direction,
                u = n.loop && (s.slidesPerView !== n.slidesPerView || p),
                m = n.loop,
                p =
                  (p && l && i.changeDirection(),
                  v(i.params, s),
                  i.params.enabled),
                h = i.params.loop
              Object.assign(i, {
                ...
                a && !p ? i.disable() : !a && p && i.enable(),
                (i.currentBreakpoint = c),
                i.emit('_beforeBreakpoint', s),
                l &&
                  (u
                    ? (i.loopDestroy(), i.loopCreate(r), i.updateSlides())
                    : !m && h
                    ? (i.loopCreate(r), i.updateSlides())
                    : m && !h && i.loopDestroy()),
                i.emit('breakpoint', s)
            }
          }
  ...
  class u {
    ...
    getSlideIndex (e) {
      var { slidesEl: t, params: a } = this,
        t = S(q(t, `.${a.slideClass}, swiper-slide`)[0])
      return S(e) - t
    }
    ...
    return (
      a.params.createElements &&
        Object.keys(r).forEach(t => {
          if (!i[t] && !0 === i.auto) {
            let e = q(a.el, '.' + r[t])[0]
            e || (((e = I('div', r[t])).className = r[t]), a.el.append(e)),
              (i[t] = e),
              (s[t] = e)
          }
        }),
  ...
  function x (e, t, a) {
    ...
    return s || ((s = I('div', a.split(' '))), e.append(s)), s
  }
  return (
    ...
    u.use([
      function (e) {
        let t,
          { swiper: T, extendParams: a, on: s, emit: L } = e
        a({
          virtual: {
            enabled: !1,
            slides: [],
        ...
        function l (a) {
          ...
          let m,
            ...
            g =
              ...
              u -
                (v = s
                  ? ((h = Math.floor(e / 2) + t + l), Math.floor(e / 2) + t + r)
                  : ((h = e + (t - 1) + l), (i ? e : t) + r))),
            f = u + h,
            b =
              (i || ((g = Math.max(g, 0)), (f = Math.min(f, d.length - 1))),
          ...
          if (
            (i && u >= v
              ? ((g -= v), s || (b += T.slidesGrid[0]))
              : i && u < v && ((g = -v), s) && (b += T.slidesGrid[0]),
            ...
            if (T.params.virtual.renderExternal)
              T.params.virtual.renderExternal.call(T, {
                ...
                slides: (function () {
                  var t = []
                  for (let e = g; e <= f; e += 1) t.push(d[e])
                  return t
                })()
              }),
                ...
                for (let e = n; e <= o; e += 1)
                  if (e < g || e > f) {
                    ...
                    T.slides
                      .filter(e =>
                        e.matches(
                          `.${T.params.slideClass}[data-swiper-slide-index="${t}"], swiper-slide[data-swiper-slide-index="${t}"]`
                        )
                      )
                      .forEach(e => {
                        e.remove()
        ...
        s('beforeInit', () => {
          if (T.params.virtual.enabled) {
            let e
            var t
            void 0 === T.passedParams.virtual.slides &&
              (t = [...T.slidesEl.children].filter(e =>
                e.matches(`.${T.params.slideClass}, swiper-slide`)
              )) &&
              t.length &&
              ((T.virtual.slides = [...t]),
          ...
          s('init update resize', () => {
            T.params.virtual.enabled &&
              T.params.cssMode &&
              A(T.wrapperEl, '--swiper-virtual-size', T.virtualSize + 'px')
          }),
          Object.assign(T.virtual, {
            ...
            prependSlide: function (t) {
              ...
              } else T.virtual.slides.unshift(t)
              if (T.params.virtual.cache) {
                let s = T.virtual.cache,
                  i = {}
                    ...
                    T.params.virtual.cache &&
                      ...
                      Object.keys(T.virtual.cache).forEach(e => {
                        a < e &&
                          ...
                          T.virtual.cache[e - 1].setAttribute(
                            'data-swiper-slide-index',
                            e - 1
                          ),
      ...
      function (e) {
        ...
        function s (c) {
          if (p.enabled) {
            ...
            if (
              !p.allowSlideNext &&
              ((p.isHorizontal() && l) || (p.isVertical() && d) || i)
            )
              return !1
            if (
              !p.allowSlidePrev &&
              ((p.isHorizontal() && r) || (p.isVertical() && n) || s)
            )
              return !1
            if (
              !(
              ...
              if (
                ...
                let a = !1
                if (
                  0 < O(p.el, `.${p.params.slideClass}, swiper-slide`).length &&
                  0 === O(p.el, '.' + p.params.slideActiveClass).length
                )
                  return
                let e = p.el,
                  t = e.clientWidth,
              ...
              p.isHorizontal()
                ? ((s || i || r || l) &&
                    (e.preventDefault
                      ? e.preventDefault()
                      : (e.returnValue = !1)),
                  (((i || l) && !o) || ((s || r) && o)) && p.slideNext(),
                  (((s || r) && !o) || ((i || l) && o)) && p.slidePrev())
                : ((s || i || n || d) &&
                    (e.preventDefault
                      ? e.preventDefault()
                      : (e.returnValue = !1)),
      ...
      function (e) {
        ...
        function v (e) {
          ;(c.params.mousewheel.thresholdDelta &&
            ...
            (c.params.mousewheel.thresholdTime &&
              f() - i < c.params.mousewheel.thresholdTime) ||
            (6 <= e.delta && f() - i < 60) ||
            (e.direction < 0
        ...
        function n (s) {
          ...
          if (
            ...
            if (!c.mouseEntered && !t && !n.releaseOnEdges) return !0
            ...
            if (0 === r) return !0
            n.invert && (r = -r)
            let a = c.getTranslate() + r * n.sensitivity
            if (
        ...
        function d () {
          return c.params.cssMode
            ? (c.wrapperEl.removeEventListener('wheel', n), !0)
            : !c.mousewheel.enabled &&
                (o('addEventListener'), (c.mousewheel.enabled = !0))
        }
        function g () {
          return c.params.cssMode
            ? (c.wrapperEl.addEventListener(event, n), !0)
            : !!c.mousewheel.enabled &&
      ...
      function (e) {
        ...
        function c () {
          ...
          if (
            ...
            var e = l(a.nextEl),
              s = l(a.prevEl)
            Object.assign(i.navigation, { nextEl: e, prevEl: s }),
              (e = B(e)),
              (s = B(s))
            let t = (e, t) => {
              e && e.addEventListener('click', 'next' === t ? d : o),
                !i.enabled && e && e.classList.add(...a.lockClass.split(' '))
            }
        ...
        t({
          ...
          a('enable disable', () => {
            ...
            i.enabled
              ...
              : [...e, ...t]
                  .filter(e => !!e)
                  .forEach(e => e.classList.add(i.params.navigation.lockClass))
          }),
          a('click', (e, t) => {
            ...
            if (
              ...
              let e
              a.length
                ? (e = a[0].classList.contains(i.params.navigation.hiddenClass))
                : s.length &&
                ...
                [...a, ...s]
                  .filter(e => !!e)
                  .forEach(e =>
                    e.classList.toggle(i.params.navigation.hiddenClass)
                  )
            }
          })
        let u = () => {
        ...
        function r () {
          ...
          if (!i()) {
            ...
            if (
              ...
              if (
                (o.dynamicBullets &&
                  ((p = H(s[0], d.isHorizontal() ? 'width' : 'height', !0)),
                  t.forEach(e => {
                    e.style[d.isHorizontal() ? 'width' : 'height'] =
                      p * (o.dynamicMainBullets + 4) + 'px'
                  }),
            ...
            t.forEach((s, e) => {
              if (
                ('fraction' === o.type &&
                  (s.querySelectorAll(G(o.currentClass)).forEach(e => {
                    e.textContent = o.formatFractionCurrent(l + 1)
                  }),
                  s.querySelectorAll(G(o.totalClass)).forEach(e => {
                ...
                'horizontal' == i ? (t = e) : (a = e),
                  s.querySelectorAll(G(o.progressbarFillClass)).forEach(e => {
                ...
                'custom' !== s.type && (e.innerHTML = a || ''),
                  'bullets' === s.type &&
                    d.pagination.bullets.push(
                      ...e.querySelectorAll(G(s.bulletClass))
                    )
              }),
          ...
          if (t.el) {
            ...
            ;(e =
              ...
              (d.params.uniqueNavElements &&
                ...
                (e = e.filter(e => O(e, '.swiper')[0] === d.el)[0]),
      ...
      function (e) {
        ...
        function h () {
          ...
          o.params.scrollbar.el &&
            ...
            (t.style.width = ''),
            (t.style.height = ''),
            (c = o.isHorizontal() ? a.offsetWidth : a.offsetHeight),
            (s =
              o.size /
              (o.virtualSize +
        ...
        function S () {
          ...
          if (i.el) {
            ...
            ;(e =
              ...
              e &&
                ((t = e.querySelector(G(o.params.scrollbar.dragClass))) ||
                  ((t = I('div', o.params.scrollbar.dragClass)), e.append(t))),
        ...
        t({
          ...
          a('init', () => {
            ;(!1 === o.params.scrollbar.enabled ? x : (S(), h(), i))()
          }),
      ...
      function (e) {
        let { swiper: c, extendParams: t, on: a } = e,
          ...
          s = () => {
            let { el: e, slides: t, progress: s, snapGrid: i } = c,
              a = q(e, r)
            c.isElement && a.push(...q(c.hostEl, r)),
              a.forEach(e => {
                l(e, s)
              }),
              t.forEach((e, t) => {
      ...
      function (e) {
        let { swiper: E, extendParams: t, on: a, emit: s } = e,
          x = k()
        t({
          zoom: {
            enabled: !1,
        ...
        function p (t) {
          ...
          return (
            t.target.matches(e) ||
            0 < E.slides.filter(e => e.contains(t.target)).length
          )
        }
        function u (t) {
          if (('mouse' === t.pointerType && n.splice(0, n.length), p(t))) {
            ...
            if (((i = !1), (r = !1), n.push(t), !(n.length < 2))) {
              if (((i = !0), (L.scaleStart = c()), !L.slideEl)) {
                ;(L.slideEl = t.target.closest(
                  `.${E.params.slideClass}, swiper-slide`
                )),
                  L.slideEl || (L.slideEl = E.slides[E.activeIndex])
                let e = L.slideEl.querySelector('.' + a.containerClass)
                if (
                  ((e =
                    e &&
                    e.querySelectorAll(
                  ...
                  (L.imageEl = e),
                  (L.imageWrapEl = e
                    ? O(L.imageEl, '.' + a.containerClass)[0]
                    : void 0),
                  !L.imageWrapEl)
                )
              ...
              if (L.imageEl) {
                let [e, t] =
                  n.length < 2
                    ? { x: null, y: null }
                    : ((a = L.imageEl.getBoundingClientRect()),
                      [
                        (n[0].pageX +
        ...
        function m (t) {
          ...
          p(t) &&
            ...
            n.length < 2 ||
              ...
              (L.scaleMove = c()),
              L.imageEl &&
                ((a.scale = (L.scaleMove / L.scaleStart) * T),
                a.scale > L.maxRatio &&
                  (a.scale =
                    L.maxRatio - 1 + (a.scale - L.maxRatio + 1) ** 0.5),
                a.scale < e.minRatio &&
                  (a.scale =
        ...
        function h (t) {
          ...
          !p(t) ||
            ...
            i &&
              r &&
              ((i = !1), (r = !1), L.imageEl) &&
              ((a.scale = Math.max(Math.min(a.scale, L.maxRatio), e.minRatio)),
              (L.imageEl.style.transitionDuration = E.params.speed + 'ms'),
              (L.imageEl.style.transform = `translate3d(0,0,0) scale(${a.scale})`),
              (T = a.scale),
              (l = !1),
              1 < a.scale && L.slideEl
                ? L.slideEl.classList.add('' + e.zoomedSlideClass)
                : a.scale <= 1 &&
                  L.slideEl &&
                  L.slideEl.classList.remove('' + e.zoomedSlideClass),
              1 === a.scale) &&
        ...
        function v (e) {
          if (
            p(e) &&
            ((t = e),
            (a = '.' + E.params.zoom.containerClass),
            t.target.matches(a) ||
              0 <
                [...E.hostEl.querySelectorAll(a)].filter(e =>
                  e.contains(t.target)
                ).length)
          ) {
            var t,
            ...
            if (L.imageEl && M.isTouched && L.slideEl) {
              ...
              var s = M.width * a.scale,
                i = M.height * a.scale
              if (!(s < L.slideWidth && i < L.slideHeight)) {
                if (
                  ((M.minX = Math.min(L.slideWidth / 2 - s / 2, 0)),
                  (M.maxX = -M.minX),
                ...
                e.cancelable && e.preventDefault(),
                  e.stopPropagation(),
                  (M.isMoved = !0)
                var s = (a.scale - T) / (L.maxRatio - E.params.zoom.minRatio),
                ...
                ;(M.currentX =
                  ...
                  (o.x =
                    (M.touchesCurrent.x - o.prevPositionX) /
                    (Date.now() - o.prevTime) /
                    2),
                  (o.y =
                    (M.touchesCurrent.y - o.prevPositionY) /
                    (Date.now() - o.prevTime) /
                    2),
                  Math.abs(M.touchesCurrent.x - o.prevPositionX) < 2 &&
                    (o.x = 0),
                  Math.abs(M.touchesCurrent.y - o.prevPositionY) < 2 &&
                    (o.y = 0),
        ...
        function f (b) {
          ...
          if (L.imageEl && L.imageWrapEl) {
            ...
            1 === T && S && ((e = void 0), (t = void 0)),
              ...
              !b || (1 === T && S)
                ? ((l = 0), (n = 0))
                : ((g = L.slideEl.offsetWidth),
                  (f = L.slideEl.offsetHeight),
                  (a = D(L.slideEl).left + x.scrollX),
                  (s = D(L.slideEl).top + x.scrollY),
                  (i = a + g / 2 - e),
                  (r = s + f / 2 - t),
                  ...
                  (l = l < u ? u : l) > h && (l = h),
                  (n = n < m ? m : n) > v && (n = v)),
              S && 1 === y.scale && ((L.originX = 0), (L.originY = 0)),
        ...
        function b () {
          ...
          if (!L.slideEl) {
            ...
            ;(e =
              ...
              (L.imageEl = e),
              (L.imageWrapEl = e
                ? O(L.imageEl, '.' + t.containerClass)[0]
                : void 0)
          }
          L.imageEl &&
            L.imageWrapEl &&
        ...
        Object.defineProperty(E.zoom, 'scale', {
          ...
          set (e) {
            var t, a
            d !== e &&
              ((t = L.imageEl), (a = L.slideEl), s('zoomChange', e, t, a)),
              (d = e)
          }
        }),
          a('init', () => {
            ...
            if (E.zoom.enabled) {
              ...
              if (L.imageEl) {
                ...
                var s = o.x * e,
                  ...
                  i = M.currentY + i,
                  r =
                    (0 !== o.x && (e = Math.abs((s - M.currentX) / o.x)),
                    0 !== o.y && (t = Math.abs((i - M.currentY) / o.y)),
                    Math.max(e, t)),
                  s = ((M.currentX = s), (M.currentY = i), M.width * a.scale),
                  i = M.height * a.scale
                ;(M.minX = Math.min(L.slideWidth / 2 - s / 2, 0)),
                  (M.maxX = -M.minX),
                  (M.minY = Math.min(L.slideHeight / 2 - i / 2, 0)),
        ...
        t({ controller: { control: void 0, inverse: !1, by: 'slide' } }),
          ...
          a('beforeInit', () => {
            if (
              ...
              let a = document.querySelector(n.params.controller.control)
              if (a && a.swiper) n.controller.control = a.swiper
              else if (a) {
                let t = e => {
                  ;(n.controller.control = e.detail[0]),
                    n.update(),
                    a.removeEventListener('init', t)
                }
                a.addEventListener('init', t)
              }
      ...
      function (e) {
        ...
        function m (e) {
          ...
          ;(13 !== e.keyCode && 32 !== e.keyCode) ||
            ...
            n.pagination &&
              ...
              !e.target.matches(G(n.params.pagination.bulletClass))) ||
            (n.navigation &&
              n.navigation.nextEl &&
        ...
        let g = (e, t, a) => {
          ...
          y = e => {
            ...
            n.a11y.clicked ||
              ((t = e.target.closest(
                `.${n.params.slideClass}, swiper-slide`
              )) &&
                n.slides.includes(t) &&
        ...
        a('beforeInit', () => {
          ;(o = I('span', n.params.a11y.notificationClass)).setAttribute(
            'aria-live',
            'assertive'
          ),
            ...
            n.params.a11y.enabled &&
              (() => {
                ...
                var i,
                  ...
                  e = B(e),
                  l = B(l)
                e && e.forEach(e => g(e, s, t.nextSlideMessage)),
                  l && l.forEach(e => g(e, s, t.prevSlideMessage)),
                  v() &&
                    B(n.pagination.el).forEach(e => {
          ...
          a('fromEdge toEdge afterInit lock unlock', () => {
            ...
            n.params.a11y.enabled &&
              ...
              t && (n.isBeginning ? (p(t), r) : (u(t), i))(t),
              e) &&
              (n.isEnd ? (p(e), r) : (u(e), i))(e)
          }),
          a('paginationUpdate', () => {
              ...
              h() &&
                n.pagination.bullets.forEach(e => {
                  n.params.pagination.clickable &&
                    ...
                    e.matches(G(n.params.pagination.bulletActiveClass))
      ...
      function (e) {
        ...
        function y (e) {
          n &&
            ...
            (n.wrapperEl.removeEventListener('transitionend', y), v || L())
        }
        let w = () => {
            var e
            !n.destroyed &&
              n.autoplay.running &&
              (n.autoplay.paused ? (i = !0) : i && ((f = d), (i = !1)),
          ...
          S = s => {
            if (!n.destroyed && n.autoplay.running) {
              ...
              ;(g = n.params.autoplay.delay), (f = n.params.autoplay.delay)
              var i = (() => {
                var e =
              ...
              (e = () => {
                o('autoplayPause'),
                  n.params.autoplay.waitForTransition
                    ? n.wrapperEl.addEventListener('transitionend', y)
                    : L()
              }),
              (n.autoplay.paused = !0),
              t
          ...
          M = () => {
            ...
            !n.destroyed &&
              n.autoplay.running &&
              ('hidden' === (e = C()).visibilityState && ((h = !0), T(!0)),
              'visible' === e.visibilityState) &&
              L()
          },
          A = e => {
            'mouse' === e.pointerType &&
              ((h = !0), (v = !0), n.animating || n.autoplay.paused || T(!0))
          },
          k = e => {
            'mouse' === e.pointerType && ((v = !1), n.autoplay.paused) && L()
          }
        a('init', () => {
          n.params.autoplay.enabled &&
            (n.params.autoplay.pauseOnMouseEnter &&
              (n.el.addEventListener('pointerenter', A),
          ...
          a('beforeTransitionStart', (e, t, a) => {
            !n.destroyed &&
              n.autoplay.running &&
              (a || !n.params.autoplay.disableOnInteraction ? T(!0, !0) : x())
          }),
          a('sliderFirstMove', () => {
            !n.destroyed &&
              n.autoplay.running &&
          ...
          Object.assign(n.autoplay, { start: E, stop: x, pause: T, resume: L })
      },
      function (e) {
          ...
          if (i && !i.destroyed) {
            ...
            if (o.realIndex !== i.realIndex || n) {
              ...
              if (i.params.loop) {
                ...
                (t = o.realIndex), (a = t > o.previousIndex ? 'next' : 'prev')
              n && (t += 'next' === a ? l : -1 * l),
                i.visibleSlidesIndexes &&
        ...
        ;(o.thumbs = { swiper: null }),
          a('beforeInit', () => {
            let s = o.params.thumbs
            if (s && s.swiper)
              if (
                'string' == typeof s.swiper ||
                s.swiper instanceof HTMLElement
              ) {
                let e = C(),
                  t = () => {
                    o.destroyed ||
      ...
      function (e) {
        ...
        n({
          ...
          setTranslate: () => {
            ...
            u.shadow &&
              (m
                ? ((l = f.wrapperEl.querySelector('.swiper-cube-shadow')) ||
                    ((l = I('div', 'swiper-cube-shadow')),
                    f.wrapperEl.append(l)),
                  (l.style.height = a + 'px'))
                : (l = e.querySelector('.swiper-cube-shadow')) ||
                  ((l = I('div', 'swiper-cube-shadow')), e.append(l)))
            for (let o = 0; o < d.length; o += 1) {
              ...
              t % 4 == 0
                ...
                : (t - 2) % 4 == 0
                ? ((r = p + 4 * s * p), (n = p))
                : (t - 3) % 4 == 0 && ((r = -p), (n = 3 * p + 4 * p * s)),
                c && (r = -r),
                m || ((l = r), (r = 0))
              var g = `rotateX(${m ? 0 : -a}deg) rotateY(${
                m ? a : 0
              }deg) translate3d(${r}px, ${l}px, ${n}px)`
              i <= 1 &&
                -1 < i &&
                ((v = 90 * t + 90 * i),
                c && (v = 90 * -t - 90 * i),
            ...
            if (
              ...
              if (m)
                l.style.transform = `translate3d(0px, ${
                  a / 2 + u.shadowOffset
                ...
                let e = Math.abs(v) - 90 * Math.floor(Math.abs(v) / 90),
                  ...
                  s = u.shadowScale / t,
                  i = u.shadowOffset
                l.style.transform = `scale3d(${a}, 1, ${s}) translate3d(0px, ${
                  r / 2 + i
                }px, ${-r / 2 / s}px) rotateX(-89.99deg)`
              }
            var i =
              (s.isSafari || s.isWebView) && s.needPerspectiveFix ? -p / 2 : 0
            ;(t.style.transform = `translate3d(0px,0,${i}px) rotateX(${
              f.isHorizontal() ? 0 : v
            }deg) rotateY(${f.isHorizontal() ? -v : 0}deg)`),
      ...
      function (e) {
        let { swiper: p, extendParams: t, on: a } = e,
          u =
            ...
            (e, t) => {
              let a = p.isHorizontal()
                  ? e.querySelector('.swiper-slide-shadow-left')
                  : e.querySelector('.swiper-slide-shadow-top'),
                s = p.isHorizontal()
                  ? e.querySelector('.swiper-slide-shadow-right')
                  : e.querySelector('.swiper-slide-shadow-bottom')
              ;(a = a || x('flip', e, p.isHorizontal() ? 'left' : 'top')),
                (s = s || x('flip', e, p.isHorizontal() ? 'right' : 'bottom')),
        ...
        n({
          ...
          setTranslate: () => {
            ...
            for (let r = 0; r < l.length; r += 1) {
              ...
              let t = -180 * e,
                a = 0,
                s = p.params.cssMode ? -c - p.translate : -c,
                i = 0
              p.isHorizontal()
                ? n && (t = -t)
                : ((i = s), (s = 0), (a = -t), (t = 0)),
          ...
          setTransition: t => {
            ...
            e.forEach(e => {
              ...
              m({ swiper: p, duration: t, transformElements: e })
          },
          recreateShadows: () => {
            p.params.flipEffect,
              p.slides.forEach(e => {
            ...
            setTranslate: () => {
              ...
              for (let p = 0, e = u.length; p < e; p += 1) {
                ...
                if (
                  ...
                  ;(e = e || x('coverflow', a, v ? 'left' : 'top')),
                    (t = t || x('coverflow', a, v ? 'right' : 'bottom')),
      ...
      function (e) {
        ...
        n({
          ...
          on: a,
          setTranslate: () => {
            let { slides: c, wrapperEl: t, slidesSizesGrid: a } = b,
            ...
            for (let d = 0; d < c.length; d += 1) {
              ...
              s < 0
                ...
                r.forEach((e, t) => {
                  r[t] = `calc(${e}px + (${
                    ((e = o.translate[t]), 'string' == typeof e ? e : e + 'px')
                  } * ${Math.abs(s * u)}))`
                }),
                l.forEach((e, t) => {
                  let a = o.rotate[t] * Math.abs(s * u)
                  b.browser &&
                    b.browser.need3dFix &&
                    (Math.abs(a) / 90) % 2 == 1 &&
                    (a += 0.001),
          ...
          setTransition: t => {
            ...
            e.forEach(e => {
              ...
              m({ swiper: b, duration: t, transformElements: e, allSlides: !0 })
          },
      ...
      `)
            ...
            setTransition: t => {
              ...
              e.forEach(e => {
                ...
                m({ swiper: w, duration: t, transformElements: e })
            },
            perspective: () => !0,
            overwriteParams: () => ({
              watchSlidesProgress: !0,
